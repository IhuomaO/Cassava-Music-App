module.exports = {
  chainWebpack: (config) => {
    config.plugin("html").tap((args) => {
      ...
      args[0].description =
        "A music app that consumes spotify music API and built using Vue, Vuex, Vue Router and Vuetify";
      args[0].base_url = "https://cassava-music-cloud.netlify.app//";
