<template>
  <v-container class="search px-5">
    <div
      ...
      "
    >
    Albums <br/>matching "{{keyword}}"
    </div>
     <v-col cols="12" sm="6" lg="4"  class="px-md-1 px-0">
          <v-spacer>
    ...
    <div v-if="keyword">
      <v-row class="mx-0">
        <v-col cols="12">
          <div class="text-left">
            <div class="text-h5 font-weight-bold">Searched Albums</div>
            <div
      ...
      <div class="top-albums mt-5">
        <div class="text-h5 font-weight-bold">Popular Albums</div>
